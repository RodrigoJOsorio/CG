...
// El atributo boolean nos dice si es activada la animación 
// Light attributes
...
// Animación en eje Y
float ballY = 0;           // Posición vertical actual de la pelota en el eje Y
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glfwPollEvents();
		DoMovement();
		Animation();	// Función para el contenido que lleva animación 
		...
		// Set matrices para fuentes de luz
		glUniformMatrix4fv(viewLoc, 1, GL_FALSE, glm::value_ptr(view));
		glUniformMatrix4fv(projLoc, 1, GL_FALSE, glm::value_ptr(projection));
		model = glm::mat4(1);
...
void KeyCallback(GLFWwindow *window, int key, int scancode, int action, int mode)
{
	...
	// activación de la variable booleana 
