...
int main() {
 ...
 /*
 * función void es para manejar la entrada del teclado
 *	if, si esta presionada la tecla esc, se va a cerrar la ventana o termina ejecución
 ...
 */
 ...
 void Inputs(GLFWwindow *window) {
	 ...
	 if (glfwGetKey(window, GLFW_KEY_A) == GLFW_PRESS)
		 movX -= 0.08f;
	 if (glfwGetKey(window, GLFW_KEY_Y) == GLFW_PRESS) //UP
		 movY += 0.08f;
