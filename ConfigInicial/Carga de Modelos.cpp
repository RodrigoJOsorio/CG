...
// Other Libs
//bibliotecas que nos ayudan a la carga del modelo 3D 
...
// Camera
//definición de la posición de la camara
...
int main( )
{
    ...
    //Se cargan los nuevos Shader con su ruta
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //Creación del modelo en 3D con la variable que se utilizo
        glm::mat4 model(1);
